...
execute if score $sounds sign matches 1 as @a[scores={drop_dye=1..}] at @s if score @s battle_lines matches 5.. at @a[team=player,tag=!loser] run playsound entity.player.splash ambient @a ~ ~ ~ 1
...
execute if score $sounds sign matches 1 as @a[scores={drop_tnt=1..}] at @s if score @s battle_lines matches 50.. at @s run playsound entity.generic.explode ambient @s ~ ~ ~ 1
...
execute if score $sounds sign matches 1 as @a[scores={drop_ice=1..}] at @s if score @s battle_lines matches 10.. at @a[team=player,tag=!loser] run playsound block.glass.break ambient @a ~ ~ ~ 1
...
execute if score $sounds sign matches 1 as @a[scores={drop_gray=1..}] at @s if score @s battle_lines matches 10.. at @a run playsound block.note_block.bit ambient @s ~ ~ ~ 1
