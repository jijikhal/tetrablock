...
data modify entity @e[tag=leaderboard1,limit=1] CustomName set from block 56 98 -66 Text1
data modify entity @e[tag=leaderboard2,limit=1] CustomName set from block 56 98 -66 Text2
data modify entity @e[tag=leaderboard3,limit=1] CustomName set from block 56 98 -66 Text3
data modify entity @e[tag=leaderboard4,limit=1] CustomName set from block 56 98 -66 Text4
data modify entity @e[tag=leaderboard5,limit=1] CustomName set from block 56 97 -66 Text1
