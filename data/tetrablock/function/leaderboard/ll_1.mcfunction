kill @e[tag=lead]
summon minecraft:armor_stand 64 102 -65 {Tags:["leaderboard","lead"],Invisible:1,CustomNameVisible:1,Marker:1,CustomName:'[{"text":"Highscore","bold":true,"color":"yellow"}]'}
...
data modify entity @e[tag=leaderboard1,limit=1] CustomName set from block 56 98 -66 front_text.messages[0]
data modify entity @e[tag=leaderboard2,limit=1] CustomName set from block 56 98 -66 front_text.messages[1]
data modify entity @e[tag=leaderboard3,limit=1] CustomName set from block 56 98 -66 front_text.messages[2]
data modify entity @e[tag=leaderboard4,limit=1] CustomName set from block 56 98 -66 front_text.messages[3]
data modify entity @e[tag=leaderboard5,limit=1] CustomName set from block 56 97 -66 front_text.messages[0]
