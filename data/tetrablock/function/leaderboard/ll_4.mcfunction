...
data modify entity @e[tag=leaderboard1,limit=1] CustomName set from block 60 98 -66 front_text.messages[0]
data modify entity @e[tag=leaderboard2,limit=1] CustomName set from block 60 98 -66 front_text.messages[1]
data modify entity @e[tag=leaderboard3,limit=1] CustomName set from block 60 98 -66 front_text.messages[2]
data modify entity @e[tag=leaderboard4,limit=1] CustomName set from block 60 98 -66 front_text.messages[3]
data modify entity @e[tag=leaderboard5,limit=1] CustomName set from block 60 97 -66 front_text.messages[0]
