...
execute as @s[tag=r4] run tag @s add r5
execute as @s[tag=r4] run tag @s remove r4

execute as @s[tag=r3] run tag @s add r4
execute as @s[tag=r3] run tag @s remove r3

execute as @s[tag=r2] run tag @s add r3
execute as @s[tag=r2] run tag @s remove r2

execute as @s[tag=r1] run tag @s add r2
execute as @s[tag=r1] run tag @s remove r1

execute as @s[tag=r5] run tag @s add r1
execute as @s[tag=r5] run tag @s remove r5

execute as @s[tag=I,tag=r3] run tag @s add r1
execute as @s[tag=I,tag=r3] run tag @s remove r3

execute as @s[tag=O,tag=r2] run tag @s add r1
execute as @s[tag=O,tag=r2] run tag @s remove r2

execute as @s[tag=S,tag=r3] run tag @s add r1
execute as @s[tag=S,tag=r3] run tag @s remove r3

execute as @s[tag=Z,tag=r3] run tag @s add r1
execute as @s[tag=Z,tag=r3] run tag @s remove r3
