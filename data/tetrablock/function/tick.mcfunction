...
execute unless block 55 100 -56 oak_wall_sign run setblock 55 100 -56 minecraft:acacia_wall_sign[facing=north,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text2:'{"text":""}',Text3:'{"bold":true,"text":"              <<"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 1"},"text":""}'}
...
execute unless block 53 100 -56 oak_wall_sign run setblock 53 100 -56 minecraft:crimson_wall_sign[facing=north,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text2:'{"text":""}',Text3:'{"bold":true,"text":">>                  "}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 5"},"text":""}'}
...
data merge block 54 100 -56 {Text2:'{"text":"Start at level:","bold":true}',Text3:'{"score":{"name":"$start_lvl","objective":"sign"},"bold":true}'}
...
execute if score $mode sign matches 1 run data merge block 54 100 -64 {Text1:'{"text":"Game mode:","clickEvent":{"action":"run_command","value":"trigger sign set 9"},"bold":true}',Text2:'{"text":"Highscore","bold":true,"color":"yellow"}',Text3:'{"text":"1-8 players","bold":false}',Text4:'{"text":"(Right-click)","bold":false,"italic":true,"color":"#555555"}}'}
execute if score $mode sign matches 2 run data merge block 54 100 -64 {Text1:'{"text":"Game mode:","clickEvent":{"action":"run_command","value":"trigger sign set 9"},"bold":true}',Text2:'{"text":"Battle","bold":true,"color":"red"}',Text3:'{"text":"2-8 players","bold":false}',Text4:'{"text":"(Right-click)","bold":false,"italic":true,"color":"#555555"}}'}
execute if score $mode sign matches 3 run data merge block 54 100 -64 {Text1:'{"text":"Game mode:","clickEvent":{"action":"run_command","value":"trigger sign set 9"},"bold":true}',Text2:'{"text":"Most Lines","bold":true,"color":"aqua"}',Text3:'{"text":"1-8 players","bold":false}',Text4:'{"text":"(Right-click)","bold":false,"italic":true,"color":"#555555"}'}
execute if score $mode sign matches 4 run data merge block 54 100 -64 {Text1:'{"text":"Game mode:","clickEvent":{"action":"run_command","value":"trigger sign set 9"},"bold":true}',Text2:'{"text":"Most Pieces","bold":true,"color":"green"}',Text3:'{"text":"1-8 players","bold":false}',Text4:'{"text":"(Right-click)","bold":false,"italic":true,"color":"#555555"}'}
...
execute unless block 78 101 -89 oak_wall_sign run setblock 78 101 -89 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"black","text":"piece"}',Text2:'{"bold":true,"color":"black","text":"Show next"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 25"},"text":""}'}
...
execute unless block 80 101 -89 oak_wall_sign run setblock 80 101 -89 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"black","text":"pieces"}',Text2:'{"bold":true,"color":"black","text":"Allow saving"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 26"},"text":""}'}
...
execute unless block 81 97 -90 oak_wall_sign run setblock 81 97 -90 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"black","text":"generation"}',Text2:'{"bold":true,"color":"black","text":"random piece"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 29"},"text":"Type of","bold":true}'}
...
execute if block 81 96 -90 stone_button[powered=true] if score $random sign matches 1 run data merge block 81 97 -90 {Color:"black",Text4:'{"text":"Random","color":"red","bold":true}',Text3:'{"bold":true,"color":"black","text":"generation"}',Text2:'{"bold":true,"color":"black","text":"random piece"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 29"},"text":"Type of","bold":true}'}
execute if block 81 96 -90 stone_button[powered=true] if score $random sign matches 2 run data merge block 81 97 -90 {Color:"black",Text4:'{"text":"7 bag","color":"dark_green","bold":true}',Text3:'{"bold":true,"color":"black","text":"generation"}',Text2:'{"bold":true,"color":"black","text":"random piece"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 29"},"text":"Type of","bold":true}'}
...
execute unless block 86 101 -89 oak_wall_sign run setblock 86 101 -89 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"black","text":""}',Text2:'{"bold":true,"color":"black","text":"Time of day"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 27"},"text":""}'}
...
execute if block 86 100 -89 stone_button[powered=true] if score $time_of_day sign matches 1 run data merge block 86 101 -89 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"yellow","text":"Day"}',Text2:'{"bold":true,"color":"black","text":"Time of day"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 27"},"text":""}'}
execute if block 86 100 -89 stone_button[powered=true] if score $time_of_day sign matches 2 run data merge block 86 101 -89 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"#e49112","text":"Dusk"}',Text2:'{"bold":true,"color":"black","text":"Time of day"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 27"},"text":""}'}
execute if block 86 100 -89 stone_button[powered=true] if score $time_of_day sign matches 3 run data merge block 86 101 -89 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"#3b362e","text":"Night"}',Text2:'{"bold":true,"color":"black","text":"Time of day"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 27"},"text":""}'}
execute if block 86 100 -89 stone_button[powered=true] if score $time_of_day sign matches 4 run data merge block 86 101 -89 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"#794b05","text":"Dawn"}',Text2:'{"bold":true,"color":"black","text":"Time of day"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 27"},"text":""}'}
...
execute unless block 82 101 -89 oak_wall_sign run setblock 82 101 -89 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text2:'{"bold":true,"color":"black","text":""}',Text3:'{"bold":true,"color":"black","text":"Sounds"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 28"},"text":""}'}
...
execute unless block 84 101 -89 oak_wall_sign run setblock 84 101 -89 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text2:'{"bold":true,"color":"black","text":""}',Text3:'{"bold":true,"color":"black","text":"Music"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 30"},"text":""}'}
...
execute unless block 88 101 -89 oak_wall_sign run setblock 88 101 -89 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"black","text":""}',Text2:'{"bold":true,"color":"black","text":"Weather"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 31"},"text":""}'}
...
execute if block 88 100 -89 stone_button[powered=true] if score $weather sign matches 1 run data merge block 88 101 -89 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"aqua","text":"Sunny"}',Text2:'{"bold":true,"color":"black","text":"Weather"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 31"},"text":""}'}
execute if block 88 100 -89 stone_button[powered=true] if score $weather sign matches 2 run data merge block 88 101 -89 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"blue","text":"Rain"}',Text2:'{"bold":true,"color":"black","text":"Weather"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 31"},"text":""}'}
execute if block 88 100 -89 stone_button[powered=true] if score $weather sign matches 3 run data merge block 88 101 -89 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"dark_gray","text":"Thunder"}',Text2:'{"bold":true,"color":"black","text":"Weather"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 31"},"text":""}'}
...
execute unless block 90 101 -89 oak_wall_sign run setblock 90 101 -89 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text1:'{"bold":true,"text":"Game ends"}',Text2:'{"bold":true,"color":"black","text":"after"}',Text3:'{"bold":true,"color":"black","text":""}',Text4:'{"clickEvent":{"action":"run_command","value":"trigger sign set 32"},"text":""}'}
...
execute if block 90 100 -89 stone_button[powered=true] if score $end sign matches 1 run data merge block 90 101 -89 {Color:"black",Text1:'{"bold":true,"text":"Game ends"}',Text2:'{"bold":true,"color":"black","text":"after"}',Text3:'{"bold":true,"color":"dark_red","text":"Everyone is "}',Text4:'{"bold":true,"color":"dark_red","clickEvent":{"action":"run_command","value":"trigger sign set 32"},"text":"eliminated"}'}
execute if block 90 100 -89 stone_button[powered=true] if score $end sign matches 2 run data merge block 90 101 -89 {Color:"black",Text1:'{"bold":true,"text":"Game ends"}',Text2:'{"bold":true,"color":"black","text":"after"}',Text3:'{"bold":true,"color":"gold","text":"1 minute"}',Text4:'{"bold":true,"color":"dark_red","clickEvent":{"action":"run_command","value":"trigger sign set 32"},"text":""}'}
execute if block 90 100 -89 stone_button[powered=true] if score $end sign matches 3 run data merge block 90 101 -89 {Color:"black",Text1:'{"bold":true,"text":"Game ends"}',Text2:'{"bold":true,"color":"black","text":"after"}',Text3:'{"bold":true,"color":"yellow","text":"5 minutes"}',Text4:'{"bold":true,"color":"dark_red","clickEvent":{"action":"run_command","value":"trigger sign set 32"},"text":""}'}
execute if block 90 100 -89 stone_button[powered=true] if score $end sign matches 4 run data merge block 90 101 -89 {Color:"black",Text1:'{"bold":true,"text":"Game ends"}',Text2:'{"bold":true,"color":"black","text":"after"}',Text3:'{"bold":true,"color":"green","text":"10 minutes"}',Text4:'{"bold":true,"color":"dark_red","clickEvent":{"action":"run_command","value":"trigger sign set 32"},"text":""}'}
...
execute unless block 83 97 -90 oak_wall_sign run setblock 83 97 -90 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text1:'{"text":""}',Text4:'{"bold":true,"color":"black","text":"Shift"}',Text3:'{"bold":true,"color":"black","text":"Auto"}',Text2:'{"text":"Delayed","bold":true}'}
execute unless block 83 96 -90 warped_wall_sign run setblock 83 96 -90 minecraft:warped_wall_sign[facing=south,waterlogged=false]{Color:"black",Text1:'{"text":""}',Text4:'{"bold":true,"color":"black","text":""}',Text3:'{"bold":true,"color":"black","text":""}',Text2:'{"text":"","bold":true,"clickEvent":{"action":"run_command","value":"trigger sign set 24"}}'}
...
execute unless block 85 97 -90 oak_wall_sign run setblock 85 97 -90 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text1:'{"text":""}',Text4:'{"bold":true,"color":"black","text":"Rate"}',Text3:'{"bold":true,"color":"black","text":"Repeat"}',Text2:'{"text":"Auto","bold":true}'}
execute unless block 85 96 -90 warped_wall_sign run setblock 85 96 -90 minecraft:warped_wall_sign[facing=south,waterlogged=false]{Color:"black",Text1:'{"text":""}',Text4:'{"bold":true,"color":"black","text":""}',Text3:'{"bold":true,"color":"black","text":""}',Text2:'{"text":"","bold":true,"clickEvent":{"action":"run_command","value":"trigger sign set 23"}}'}
...
execute unless block 87 97 -90 oak_wall_sign run setblock 87 97 -90 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"black","text":""}',Text2:'{"bold":true,"color":"black","text":"Wall Kicks"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 33"},"text":"","bold":true}'}
...
execute if block 87 96 -90 stone_button[powered=true] if score $wall_kicks sign matches 1 run data merge block 87 97 -90 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"red","text":"None"}',Text2:'{"bold":true,"color":"black","text":"Wall Kicks"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 33"},"text":"","bold":true}'}
execute if block 87 96 -90 stone_button[powered=true] if score $wall_kicks sign matches 2 run data merge block 87 97 -90 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"gold","text":"Kicks"}',Text2:'{"bold":true,"color":"black","text":"Wall Kicks"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 33"},"text":"","bold":true}'}
execute if block 87 96 -90 stone_button[powered=true] if score $wall_kicks sign matches 3 run data merge block 87 97 -90 {Color:"black",Text4:'{"text":""}',Text3:'{"bold":true,"color":"green","text":"Out of well kicks"}',Text2:'{"bold":true,"color":"black","text":"Wall Kicks"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 33"},"text":"","bold":true}'}
...
#No Shift option
execute unless block 89 97 -90 oak_wall_sign run setblock 89 97 -90 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",Text1:'{"text":""}',Text4:'{"bold":true,"color":"black","text":"Period"}',Text3:'{"bold":true,"color":"black","text":"Shift"}',Text2:'{"text":"No","bold":true,"clickEvent":{"action":"run_command","value":"trigger sign set 21"}}'}
execute unless block 89 96 -90 warped_wall_sign run setblock 89 96 -90 minecraft:warped_wall_sign[facing=south,waterlogged=false]{Color:"black",Text1:'{"text":""}',Text4:'{"bold":true,"color":"black","text":""}',Text3:'{"bold":true,"color":"black","text":""}',Text2:'{"text":"","bold":true,"clickEvent":{"action":"run_command","value":"trigger sign set 22"}}'}
...
execute unless block 123 100 -62 oak_wall_sign run setblock 123 100 -62 minecraft:oak_wall_sign[facing=west,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":false,"color":"black","text":"Commands"}',Text2:'{"bold":true,"color":"dark_aqua","text":"jijik_hal"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 34"},"text":"","bold":true}'}
...
execute unless block 123 100 -58 oak_wall_sign run setblock 123 100 -58 minecraft:oak_wall_sign[facing=west,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":false,"color":"black","text":"Builds"}',Text2:'{"bold":true,"color":"red","text":"OldaLP"}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger sign set 35"},"text":"","bold":true}'}
...
execute unless block 124 100 -60 oak_wall_sign run setblock 124 100 -60 minecraft:oak_wall_sign[facing=west,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"bold":false,"color":"black","text":"Arrow icons"}',Text2:'{"bold":true,"color":"blue","text":"Freepik"}',Text1:'{"text":"","bold":true}'}


function tetrablock:tutorial/controls

execute unless block 79 100 -30 minecraft:oak_sign run setblock 79 100 -30 minecraft:oak_wall_sign[facing=east,waterlogged=false]{Color:"black",Text4:'{"color":"white","text":"of all opponents"}',Text3:'{"color":"white","text":"current piece"}',Text2:'{"color":"white","text":"Freezes the"}',Text1:'{"bold":true,"color":"aqua","text":"Ice Bomb"}'}
execute unless block 79 100 -33 minecraft:oak_sign run setblock 79 100 -33 minecraft:oak_wall_sign[facing=east,waterlogged=false]{Color:"black",Text4:'{"color":"white","text":"one row higher"}',Text3:'{"color":"white","text":"all opponents"}',Text2:'{"color":"white","text":"Moves pieces of"}',Text1:'{"bold":true,"color":"dark_gray","text":"The Destroyer"}'}
execute unless block 79 100 -36 minecraft:oak_sign run setblock 79 100 -36 minecraft:oak_wall_sign[facing=east,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"color":"white","text":"playing field"}',Text2:'{"color":"white","text":"Clears your"}',Text1:'{"bold":true,"color":"red","text":"The Cleaner"}'}
execute unless block 79 100 -39 minecraft:oak_sign run setblock 79 100 -39 minecraft:oak_wall_sign[facing=east,waterlogged=false]{Color:"black",Text4:'{"color":"white","text":"five seconds"}',Text3:'{"color":"white","text":"opponents for"}',Text2:'{"color":"white","text":"Blinds all"}',Text1:'{"bold":true,"color":"black","text":"The Blinder"}'}
