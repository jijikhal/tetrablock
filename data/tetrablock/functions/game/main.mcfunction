...
execute if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.2 with carrot_on_a_stick{CustomModelData:4,display:{Name:'{"text":"Rotate counterclockwise","italic":false}'}}
execute if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.3 with carrot_on_a_stick{CustomModelData:2,display:{Name:'{"text":"Move left","italic":false}'}}
execute if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.4 with carrot_on_a_stick{CustomModelData:5,display:{Name:'{"text":"Hard drop","italic":false}'}}
execute if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.5 with carrot_on_a_stick{CustomModelData:1,display:{Name:'{"text":"Move right","italic":false}'}}
execute if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.6 with carrot_on_a_stick{CustomModelData:3,display:{Name:'{"text":"Rotate clockwise","italic":false}'}}
...
execute if score $mode sign matches 2 if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.0 with ice{display:{Name:'[{"text":"Freeze opponents","color":"aqua","italic":false},{"text":" – 10 lines","color":"white"}]',Lore:['[{"text":"Press ","color":"gray"},{"keybind": "key.drop","color":"gray"},{"text": " to use","color":"gray"}]']}}
execute if score $mode sign matches 2 if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.1 with gray_concrete{display:{Name:'[{"text":"Move all opponents\' pieces up","color":"gray","italic":false},{"text":" – 10 lines","color":"white"}]',Lore:['[{"text":"Press ","color":"gray"},{"keybind": "key.drop","color":"gray"},{"text": " to use","color":"gray"}]']}}
execute if score $mode sign matches 2 if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.7 with tnt{display:{Name:'[{"text":"Clear playing field","color":"red","italic":false},{"text":" – 50 lines","color":"white"}]',Lore:['[{"text":"Press ","color":"gray"},{"keybind": "key.drop","color":"gray"},{"text": " to use","color":"gray"}]']}}
execute if score $mode sign matches 2 if score $game_in_progress sign matches 1 run item replace entity @a[team=player,tag=!loser] hotbar.8 with black_dye{display:{Name:'[{"text":"Blind opponents","color":"black","italic":false},{"text":" – 5 lines","color":"white"}]',Lore:['[{"text":"Press ","color":"gray"},{"keybind": "key.drop","color":"gray"},{"text": " to use","color":"gray"}]']}}
